...
public class AddCommentController : ControllerBase
{
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult> LikePostAsync(Guid id, AddCommentCommand command)
    {
        try
        {
            command.Id = id;
        ...
        catch (Exception ex)
        {
            ...
            const string SAFE_ERROR_MESSAGE = "Error while processing request to add comment in a post!";

...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void AddComment(string comment, string username)
        {
            ...
            RaiseEvent(new CommentdAddedEvent
            {
                  Id = Id,
        ...
        public void Apply(CommentdAddedEvent @event)
        {
            _id = @event.Id;
        ...
        public void DeletePost(string username)
        {
            ...
            {
                throw new InvalidOperationException("You are not allowed to delete a post that was madade by someone else!");
            }
